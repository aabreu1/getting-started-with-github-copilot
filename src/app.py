...
activities = {
    ...
    "Drama Club": {
        "description": "Theater performances, script reading, and acting workshops",
    ...
    "Science Club": {
        "description": "Engage in scientific experiments and explore advanced topics in STEM",
...
def unregister_from_activity(activity_name: str, email: str = Query(...)):
    ...
    return {"message": f"{email} ha sido eliminado de {activity_name}"}
